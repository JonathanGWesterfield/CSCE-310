CREATE TABLE classes (class varchar(20),type varchar(2),country varchar(20),numGuns int,bore int,disp int)
CREATE TABLE battles (name varchar(20), date varchar(20))
