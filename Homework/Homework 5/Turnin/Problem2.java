...
public class Problem2
{
    ...
    private String derbyConnString = "jdbc:derby:Ships;create=true";
    Connection conn;
    ...
    public Problem2() throws SQLException
    {
        this.conn = DriverManager.getConnection(derbyConnString);
        System.out.println("Connected to Database");
    }
    ...
    {
        File file = new File("ShipsRaw.sql");
        ...
        System.out.println("\nShips Database Created");
    }

    public void listShips() throws SQLException
    {
        ...
        while (rs.next())
            System.out.printf("%s\t%s\t%d\n",rs.getString("name"), rs.getString("class"), rs.getInt("launched"));
        System.out.println();
        System.out.println();
    }
}
