...
/**
 * Author: Jonathan Westerfield Summary: This class uses both ScoreReport and
 * ScoreSummary to print out the summary for a given gameID. Game ID is input
...
public class FullGameReport {
	...
	/**
	 * Check if a string is numeric. Helper for getUserGameID to make sure user is
	 * actaully puttin in a game ID
	 * 
	 * @param strNum
	 * @return
	 */
